"""codeops_tutor_dev__135974 URL Configuration
...
urlpatterns = [
    ...
    path("api/v1/", include("collaboration.api.v1.urls")),
...
admin.site.site_header = "CodeOps Tutor Dev"
admin.site.site_title = "CodeOps Tutor Dev Admin Portal"
admin.site.index_title = "CodeOps Tutor Dev Admin"
